...
function stylesTwo() {
	return gulp.src('./src/css/style.min.css', 'style.min.css.map')
...
let build = gulp.series(clear,
	gulp.parallel( fonts ,styles, stylesTwo, icons, sass, img, html, js, /*(css_styles, css__styles, css___styles*/));
